      ...
      <div className="bijnis_row1">
        ...
        <div className="ninja_row1">
          ...
          <div className="nin_row2">
            <div
              className="nin_cards"
              // style={{ backgroundColor: "#6BAD8F" }}
              style={{backgroundImage:`url(${
                window.location.origin + "/images/Total_lead.svg"
              })`}}
            ...
            >
              <p className="nin_p3">QC Passed</p>
              <p className="nin_p4">
                {Object.keys(cardsApi).length > 2
            ...
            >
              <p className="nin_p3">Store Onboarding</p>
              <p className="nin_p4">
                {Object.keys(cardsApi).length > 2
            ...
            >
              <p className="nin_p3">First Order Placement</p>
              <p className="nin_p4">
                {Object.keys(cardsApi).length > 2
                  ? cardsApi.total_order_approved
                  : "XXXX"}
