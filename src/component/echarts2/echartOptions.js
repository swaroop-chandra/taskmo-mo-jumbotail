...
export const leadStatChartOption = {
...
export const rCountChartOption = {
    color: ['#62549c', '#7566b5', '#7d6cbb', '#8877bd', '#9181bd', '#6957af'],
    tooltip: {
        show: true,
        backgroundColor: 'rgba(0, 0, 0, .8)'
...
export const echartBarOptionRapido = {
    legend: {
      borderRadius: 0,
      orient: 'horizontal',
      x: 'right',
    ...
    series: [
      ...
      {
        name: 'Today',
        data: [50, 100, 200, 300, 100, 89, 490, 91, 80.2, 286, 350, 240],
        label: { show: false, color: '#639' },
        type: 'bar',
        // color: ["#0277bd", "#039be5", '#29b6f6', '#81d4fa', '#0288d1', '#03a9f4', '#4fc3f7', '#b3e5fc'],
        color: ["#6BAD8F"],
        smooth: true,
        itemStyle: {
          emphasis: {
